...
ALTER TABLE ONLY public.orders ATTACH PARTITION public.orders_2 FOR VALUES FROM (499) TO (9999999);


ALTER TABLE public.orders_2 OWNER TO postgres;

--
-- Name: orders_full; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.orders_full (
    id integer NOT NULL,
    title character varying(80) NOT NULL,
    price integer DEFAULT 0
);
...
ALTER SEQUENCE public.orders_id_seq OWNED BY public.orders_full.id;


--
-- Name: orders_full id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_full ALTER COLUMN id SET DEFAULT nextval('public.orders_id_seq'::regclass);
...
--
-- Data for Name: orders_full; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orders_full (id, title, price) FROM stdin;
1	War and peace	100
2	My little database	500
3	Adventure psql time	300
4	Server gravity falls	300
...
--
-- Name: orders_full orders_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_full
