...
когда мы делаем sudo echo, то с правами рута исполняется только echo, а перенаправление уже с нашими текущими правами.

Более наглядно это в следующем примере:

![sh](https://i.ibb.co/JzFNjW3/2021-11-16-00-13-16.jpg)

В первом случае кавычки не захватывают перенаправление и sudo исполняет только `sh -c echo`, 
во втором случае кавычки перенаправление захватывают, и перенаправление работает в рамках sh, запущенного с правами рута.